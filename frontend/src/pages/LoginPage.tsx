      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <div className="mb-6 border-b border-slate-200/80 pb-6 text-center dark:border-slate-700">
            ...
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">Task board — plan work together</p>
          </div>
          ...
          <p className="mt-4 text-center text-sm text-slate-600 dark:text-slate-400">
            No account?{' '}
            <Link className="font-medium text-sky-600 hover:underline dark:text-sky-400" to="/register">
              Register
            </Link>
          </p>
        </form>
